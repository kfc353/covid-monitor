...
<fieldset id="dbSearchesFieldset">
    ...
    <select name="dbSearches" id="dbSearches" onChange=displayDatabaseSearch()>
        ...
        <option value="positiveWorkers">List of workers who tested positive on a given day</option>
...
<fieldset id="alertsAndMessagesFieldset">
    ...
    <select name="alertsAndMessages" id="alertsAndMessages" onChange=displayAlertsMessagesPage()>
        <option value="" disable selected hidden></option>
        <option value="setAlert">Set a new alert for a region</option>
        <option value="createMessageForPositive">Create a test result for a person</option>
        <option value="followUpForm">Follow-Up Form</option>
        <option value="symptomProgress">Get Symptom Progress of a person</option>
        <option value="createTables">List all alerts</option>

    </select>
    <?php include "alertsAndMessagesSubPages/DiagnosticForm.php" ?>
    <?php include "alertsAndMessagesSubPages/AlertSetup.php" ?>
    <?php include "alertsAndMessagesSubPages/AlertCheck.php" ?>
    <?php include "alertsAndMessagesSubPages/AlertUpdate.php" ?>
    <?php include "alertsAndMessagesSubPages/SymptomHistoryForm.php" ?>
    <?php include "alertsAndMessagesSubPages/SymptomUpdateForm.php" ?>
</fieldset>